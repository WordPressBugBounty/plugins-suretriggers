...
class Utilities extends Model {
	...
	public static function get_divi_forms() {
		...
		$sql_query = "SELECT `ID`, `post_content`, `post_title` FROM {$model->table} WHERE post_status = 'publish' AND ( post_content LIKE '%%et_pb_contact_form%%' OR post_content LIKE '%%wp:divi/contact-form%%' )";
